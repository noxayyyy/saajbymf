		...
		<div className="collapse collapse-arrow lg:collapse-open">
			...
			<div className="w-full collapse-content">
				<div className="flex justify-between w-full">
					...
					<span className="justify-end font-sans">{formatPrice(cart.subtotal * conversion_rate, currency)}</span>
				</div>
				<div className="flex justify-between w-full">
					<span className="justify-start">Shipping:</span>
					<span className="justify-end font-sans">{shipping === null ? "Enter address to calculate" : formatPrice(shipping * conversion_rate, currency)}</span>
				</div>
				<div className="divider my-0"></div>
				<div className="flex justify-between w-full">
					<span className="justify-start">Total:</span>
					<span className="justify-end font-bold font-sans">{formatPrice((cart.subtotal + (shipping ? shipping : 0)) * conversion_rate, currency)}</span>
				</div>
			</div>
		</div>
	);
