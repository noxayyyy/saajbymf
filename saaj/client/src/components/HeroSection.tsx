...
import heroImg1 from "@assets/WhatsApp_Image_2026-04-11_at_3.10.57_PM_1776156518591.jpeg";
import heroImg2 from "@assets/WhatsApp_Image_2026-04-11_at_3.12.19_PM_1776156518593.jpeg";
import heroImg3 from "@assets/WhatsApp_Image_2026-04-11_at_3.13.10_PM_1776156518594.jpeg";

const defaultSlides = [
  { image: heroImg1, title: "Bridal", subtitle: "Couture", link: "/collections/bridal", cta: "SHOP NOW" },
  { image: heroImg2, title: "Formal", subtitle: "Wear", link: "/collections/formal-wear", cta: "EXPLORE" },
  { image: heroImg3, title: "Embroidered", subtitle: "Collection", link: "/collections/embroidered", cta: "DISCOVER" },
];
            ...
            {slides.map((_, i) => (
              <button
                ...
                className={`rounded-full transition-all duration-300 ${
                  i === current ? "bg-[#c4151c] w-5 h-2" : "bg-white/60 hover:bg-white w-2 h-2"
                }`}
              />
            ))}
          </div>
